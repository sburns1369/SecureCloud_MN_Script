...
COIN3=SCN
COIN3l=SCN
COINDAEMON=securecloudd
COINDAEMONCLI=securecloud-cli
COINCORE=.securecloud
COINCONFIG=securecloud.conf
COINHOME=/home/securecloud
...
#wget  https://github.com/SecureCloud/BitcoinSecureCloud/files/2853315/SecureCloud-linux.zip
...
securecloud-cli -datadir=/home/securecloud/.securecloud getblockcount
sleep 5
#node 1 sync check
until securecloud-cli -datadir=/home/securecloud/.securecloud mnsync status | grep -m 1 'IsBlockchainSynced" : true'; do
    securecloud-cli -datadir=/home/securecloud/.securecloud getblockcount
    sleep 5
  done
}
...
function_masternode_upgrade(){
  ...
  function_read_masternode_upgrade(){
    local choice
  	read -p "Enter choice " choice
    case $choice in
      1)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_singleV4.sh)
      pause ;;
      2)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_2pack.sh)
      pause ;;
      3)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_3pack.sh)
      pause ;;
      4)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_4pack.sh)
      pause ;;
      5)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_5pack.sh)
      pause ;;
      6)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_6pack.sh)
      pause ;;
      7)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_7pack.sh)
      pause ;;
      8)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/SecureCloud_MN_Script/master/SecureCloud_8pack.sh)
      pause ;;
      b) echo -e "backing out" ;;
      B) echo -e "backing out" ;;
      x) exit 0;;
