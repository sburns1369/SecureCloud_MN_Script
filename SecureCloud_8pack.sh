...
if id "securecloud7" >/dev/null 2>&1; then
echo -e ${YELLOW} "Found user securecloud7!"${CLEAR}
MN7=1
else
sudo adduser --system --home /home/securecloud7 securecloud7
MN7=0
fi
if id "securecloud8" >/dev/null 2>&1; then
echo -e ${YELLOW} "Found user securecloud8!"${CLEAR}
MN8=1
else
sudo adduser --system --home /home/securecloud8 securecloud8
MN8=0
fi
echo
echo
...
echo
if [ ! -f /home/securecloud7/.securecloud/securecloud.conf ]; then
if [ ! -f /home/securecloud7/securecloud.conf ]; then
echo -e "${GREEN}Seventh SecureCloud Node Configuration Not Found....${CLEAR}"
echo -e "${YELLOW}Configuring Seventh SecureCloud Node${CLEAR}"
sudo mkdir /home/securecloud7/.securecloud
sudo touch /home/securecloud7/securecloud.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/securecloud7/securecloud.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/securecloud7/securecloud.conf
echo "rpcallowip=127.0.0.1" >> /home/securecloud7/securecloud.conf
echo "server=1" >> /home/securecloud7/securecloud.conf
echo "daemon=1" >> /home/securecloud7/securecloud.conf
echo "maxconnections=250" >> /home/securecloud7/securecloud.conf
echo "masternode=1" >> /home/securecloud7/securecloud.conf
echo "rpcport=18728" >> /home/securecloud7/securecloud.conf
echo "listen=0" >> /home/securecloud7/securecloud.conf
echo "externalip=[${MNIP7}]:9191" >> /home/securecloud7/securecloud.conf
echo "masternodeprivkey=$MNKEY7" >> /home/securecloud7/securecloud.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode7 : true" >> /usr/local/nullentrydev/scn.log
echo "walletVersion7 : 1.4.0COINVERSION=1.6.0" >> /usr/local/nullentrydev/scn.log
echo "scriptVersion7 : 0.99" >> /usr/local/nullentrydev/scn.log
fi
else
echo
echo -e ${YELLOW}"Found /home/securecloud7/securecloud.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Pre-stage for Seventh Node "${CLEAR}
MN7=0
fi
else
echo -e ${YELLOW}"Found /home/securecloud7/.securecloud/securecloud.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Configuration for Seventh Node"${CLEAR}
fi
echo
if [ ! -f /home/securecloud8/.securecloud/securecloud.conf ]; then
if [ ! -f /home/securecloud8/securecloud.conf ]; then
echo -e "${GREEN}Eigth SecureCloud Node Configuration Not Found....${CLEAR}"
echo -e "${YELLOW}Configuring Eigth SecureCloud Node${CLEAR}"
sudo mkdir /home/securecloud8/.securecloud
sudo touch /home/securecloud8/securecloud.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/securecloud8/securecloud.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/securecloud8/securecloud.conf
echo "rpcallowip=127.0.0.1" >> /home/securecloud8/securecloud.conf
echo "server=1" >> /home/securecloud8/securecloud.conf
echo "daemon=1" >> /home/securecloud8/securecloud.conf
echo "maxconnections=250" >> /home/securecloud8/securecloud.conf
echo "masternode=1" >> /home/securecloud8/securecloud.conf
echo "rpcport=18729" >> /home/securecloud8/securecloud.conf
echo "listen=0" >> /home/securecloud8/securecloud.conf
echo "externalip=[${MNIP8}]:9191" >> /home/securecloud8/securecloud.conf
echo "masternodeprivkey=$MNKEY8" >> /home/securecloud8/securecloud.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode8 : true" >> /usr/local/nullentrydev/scn.log
echo "walletVersion8 : 1.4.0COINVERSION=1.6.0" >> /usr/local/nullentrydev/scn.log
echo "scriptVersion8 : 0.99" >> /usr/local/nullentrydev/scn.log
fi
else
echo
echo -e ${YELLOW}"Found /home/securecloud8/securecloud.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Pre-stage for Eigth Node "${CLEAR}
MN8=0
fi
else
echo -e ${YELLOW}"Found /home/securecloud8/.securecloud/securecloud.conf"${CLEAR}
...
if [[ "$MN7" -eq "0" ]]; then
sudo cp -r /home/securecloud1/.securecloud/* /home/securecloud7/.securecloud
rm /home/securecloud7/.securecloud/securecloud.conf
cp -r /home/securecloud7/securecloud.conf /home/securecloud7/.securecloud/securecloud.conf
sleep 1
fi
if [[ "$MN8" -eq "0" ]]; then
sudo cp -r /home/securecloud1/.securecloud/* /home/securecloud8/.securecloud
rm /home/securecloud8/.securecloud/securecloud.conf
cp -r /home/securecloud8/securecloud.conf /home/securecloud8/.securecloud/securecloud.conf
sleep 1
fi
echo -e ${YELLOW}"Launching First SCN Node"${CLEAR}
securecloudd -datadir=/home/securecloud1/.securecloud -daemon
...
sleep 20
echo -e ${YELLOW}"Launching Seventh SCN Node"${CLEAR}
securecloudd -datadir=/home/securecloud7/.securecloud -daemon
sleep 20
echo -e ${YELLOW}"Launching Eigth SCN Node"${CLEAR}
securecloudd -datadir=/home/securecloud8/.securecloud -daemon
sleep 20
...
echo -e "${YELLOW}For mn7: \"securecloud-cli -datadir=/home/securecloud7/.securecloud masternode status\""${CLEAR}
echo -e "${YELLOW}For mn8: \"securecloud-cli -datadir=/home/securecloud8/.securecloud masternode status\""${CLEAR}
echo
...
echo -e "${BOLD} Masternode - \#7 IP: [${MNIP7}]:9191${CLEAR}"
echo -e "${BOLD} Masternode - \#8 IP: [${MNIP8}]:9191${CLEAR}"
fi
